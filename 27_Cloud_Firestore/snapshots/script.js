...
//                     li.innerHTML =`${obj.title} (${obj.start_date}) [${obj.description}]`;
//                     ul.appendChild(li);
...
//     })
    ...
    form.addEventListener(`submit`, function(event)
    {
        ...
        // (string) ->prebaciti u date, pa u Timestamp
        ...
        let obj = 
        {
            // values su ovo gore promenljive, tj input vrednosti, key naziv u firebase
            title:title,
    ...
    db.collection(`tasks`)
    .onSnapshot(snapshot=> // nije kolekcija dokumenata
        {
        ...
        ul.addEventListener(`click`, function(event)
        {
            ...
            if(event.target.tagName === "BUTTON")
            {
             ...
             .then(()=>
             {
                 alert(`Uspesno obrisan dokument`);
             })
             .catch(err=>
                {
                    console.log(`Greska ${err}`);
